var application = (function () {
    ...
    var tasks = [
        {
            ...
            desc: "mleko, kawa, cukier, reczeniki papierowe, kapusta, pomidory",
            isDone: false,
    ...
    var doneTask = function (param) {
        // confirm dialog
        alertify.confirm("Would like to remove this task?", function () {
            removeTask(param);
        }, function () {
            // user clicked "cancel"
        });
